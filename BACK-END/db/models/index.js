...
//Criar a variaável que recebe a conexão com banco de dados
let sequelize;
...
try {
  ...
  console.error("Error: Conexão com o banco de dados não realizado com sucesso! ", error);
}
...
//Atribuir a conezão com banco de dados para o objeto db
